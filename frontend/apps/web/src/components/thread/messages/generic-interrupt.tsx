      ...
      >
        ...
        {(shouldTruncate ||
          ...
          <motion.button
            ...
            className="w-full py-2 flex items-center justify-center border-t border-border text-muted-foreground hover:text-foreground hover:bg-muted transition-all ease-in-out duration-200 cursor-pointer"
            initial={{ scale: 1 }}
